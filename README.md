# Hi, I'm Maddie 👋
I'm a statistician and data scientist with an MA in Statistics from UC Berkeley (May 2026), where I also worked as a Graduate Student Instructor and Outreach Peer Ambassador. I hold a BS in Applied Statistics from Purdue University, where I graduated top of my class.
My work sits at the intersection of statistical modeling, machine learning, and data communication. I care about building analyses that are rigorous, reproducible, and actually interpretable.
...
| [Pediatric TBI Risk Analysis](https://github.com/madisonmacdonald111/pecarn-pediatric-tbi-analysis) | Injury risk modeling using PECARN emergency department data with full LaTeX report | R · Python · LaTeX |
| [Structural Predictors of Community-Level Homelessness](https://github.com/madisonmacdonald111/homelessness-coc-predictors) | Modeled log homelessness counts across 38 California CoCs (2010-2017) using HUD panel data merged with HRSA mental health shortage scores. Eviction rate emerged as the most robust predictor across all model specifications | R · glmnet · sandwich · LaTeX |
| [fMRI Encoding Models from Text](https://github.com/madisonmacdonald111/fmri-encoding-models) | Predicted voxelwise BOLD responses as subjects listened to podcast stories. Compared BoW, Word2Vec, GloVe, and BERT-based embeddings using ridge regression, run on Bridges2 HPC | Python · ridge regression · BERT · LoRA · HPC |
| [AI vs. Human Community Boards](https://github.com/madisonmacdonald111/reddit-vs-moltbook) | Compared Reddit and Moltbook AI agent community boards using a classifier-based Turing Community Test approach with BERTopic topic modeling | Python · BERTopic · NLP |
